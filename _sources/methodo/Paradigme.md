...
| :--------------- |:---------------|:-----|:-----|
| ![speaker dark blue](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Répondre "modulé" ou "non modulé" | Yes/no + détection |  |
| ![speaker dark blue](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![speaker light blue](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png) | Sélectionnez le stimulus modulé | Choix forcé 2I2A + détection | indépendant du critère |
