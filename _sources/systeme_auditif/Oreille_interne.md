...
Pour être complet, un modèle de la cochlée doit inclure un grand nombre de paramètres et d'équations de façon à simuler les mouvements du liquide, l'entraînement de la membrane basilaire mais également la chaîne de xxx couplés d'inertie mécanique variable qui la composent ainsi que les effets de rétroaction dont il sera question plus loin. Ce domaine fait donc actuellement l'objet d'importants travaux.
