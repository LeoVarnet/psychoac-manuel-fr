...
La figure suivante représente les résultats obtenus en moyenne dans cette petite expérience. Pour plus de simplicité, le seuil de détection n'est pas exprimé en dB mais directement en nombre de tons successifs perçus. On constate que la sensibilité de l'oreille humaine n'est pas équivalente sur tout le spectre sonore : certaines fréquence sont aisément détectées (autour de 1000-2000 Hz) tandis que d'autres nécessitent des intensités sonores plus importantes pour être perçues (p.ex. 125 Hz et 8000 Hz).
