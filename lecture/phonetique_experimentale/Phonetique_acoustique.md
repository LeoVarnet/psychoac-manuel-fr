...
Comme attendu d'après nos premières observations ({numref}`Vowels.png`), les fréquences des formants F1 et F2 pour différentes réalisations d'une même voyelle (ici "è") sont très similaires (environ 700 Hz pour F1 et 2200 Hz pour F2), bien qu’elles présentent une certaine variabilité. Cette dispersion reflète l’impossibilité pour l’appareil phonatoire humain de produire un son strictement identique à plusieurs reprises. Néanmoins, la concentration des points autour de valeurs centrales confirme que les formants sont une propriété déterminante de l’identité des voyelles.
...
align: center
---
*Spectrogrammes des consonnes "d" et "t", en contexte "a", "i" ou "ou".*
```
...
align: center
---
*Spectrogrammes des sons "ada", "idi" et "oudou". Les lignes pointillées bleues représentent les trajectoires des formants F1 et F2 au cours de la deuxième syllabe.*
```
