...
| :--------------- |:---------------|:-----| <!-- :-----| -->
| ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Répondre "bleu" ou "orange" | Yes/no + détection | <!-- scores entre 50% et 100% | -->
| ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png) | Sélectionnez le stimulus "bleu" | Choix forcé 2I2A + détection | <!-- indépendant du critère, scores entre 50% et 100% | -->
| ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png) | Répondre "identiques" ou "différents" |    Yes/no + discrimination | <!-- implicite, scores entre 50% et 100% | -->
| ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Sélectionnez le stimulus "bleu" | Choix forcé 3I2A + détection | <!-- indépendant du critère, scores entre 33% et 100% | -->
| ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Sélectionnez le stimulus différent | Choix forcé 3I2A + discrimination | <!-- implicite et indépendant du critère, scores entre 33% et 100% | -->
