...
Nous sommes constamment exposé·es à des sons de parole, que notre cerveau comprend quasi-instantanément et sans effort apparent. Le processus semble aller de soi, à tel point qu'il est difficile a priori d'imaginer que ce mécanisme de décodage fasse l'objet de recherches approfondies depuis maintenant plus d'un siècle. De même qu'il suffit de disposer d'une copie de l'alphabet morse pour être en mesure de déchiffrer un message codé en morse, ne suffit-il pas à notre cerveau de mémoriser la table de conversion des sons en phonèmes pour décoder les sons de parole ? Si chaque consonne et chaque voyelle est associée à un son particulier et spécifique, il est assez simple d'imaginer un mécanisme de décodage. Dans cette section, nous examinerons en détail des sons de parole pour tenter d'établir cet "alphabet acoustico-phonétique". Ceci nous amènera à identifier les problèmes théoriques auquel se trouve confrontée cette explication intuitive.
