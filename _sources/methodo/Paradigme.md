...
| :--------------- |:---------------|:-----|:-----|
| ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Répondre "bleu" ou "orange" | Yes/no + détection |  |
| ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png) | Sélectionnez le stimulus "bleu" | Choix forcé 2I2A + détection | indépendant du critère |
| ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png) | Répondre "identiques" ou "différents" |    Yes/no + discrimination | implicite |
| ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![bleu](https://upload.wikimedia.org/wikipedia/commons/6/62/Fairytale_kmix.png)   ![orange](https://upload.wikimedia.org/wikipedia/commons/e/ea/Fairytale_arts.png) | Sélectionnez le stimulus "bleu" | Choix forcé 3I2A + détection | indépendant du critère |
