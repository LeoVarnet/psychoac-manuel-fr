...
Cette expérience extrêmement simple suit la **méthode des limites descendante**, une méthode adaptative très simple qui consiste à choisir un niveau de départ facile sur la dimension d'intérêt (ici l'intensité des bips) puis à augmenter progressivement la difficulté d'un essai à l'autre par pas constant jusqu'à ce que le participant ou la participante ne soit plus en mesure de réaliser la tâche demandée. À l'inverse, la **méthode des limites ascendante** part d'un niveau difficile pour s'arrêter dès que le sujet  parvient à effectuer la tâche.
